export const promptCards = Array.from({ length: 20 }, (_, i) => ({
    id: i + 1,
    beforeImg: "/Profile.png",
    afterImg: `/GeneratedImg${(i % 3) + 1}.png`,
    title: [
        "Bold in Red: Cinematic Elegance Unveiled",
        "Drowned in Shadow: A Cinematic Half-Face Portrait",
        "Neon Reverie: Tokyo Nights in Motion"
    ][i % 3],
    prompt: [
